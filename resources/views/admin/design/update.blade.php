...
@section('head.title','Cập nhật thiết kế')
...
@section('body.breadcrumb')
    {{ Breadcrumbs::render('admin.design.edit', $product->product_name) }}
@endsection
        ...
        <div id="ui-view">
            <div>
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-md-8">
                            <form method="post" action="{{route('admin.design.update',['id' => $product->id])}}" enctype="multipart/form-data" id="form">
                                @csrf
                                <div class="card">
                                    <div class="card-header">
                                        <i class="icon-note"></i> Tạo Mới thiết kế
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label" for="text-input">Tên thiết kế</label>
                                            <div class="col-md-10">
                                                <input class="form-control" id="text-input" type="text" name="product_name" placeholder="Tên thiết kế"
                                                    value="{{ $product->product_name }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label" for="text-input">Mã thiết kế</label>
                                            <div class="col-md-10">
                                                <input class="form-control" id="text-input" type="text" name="product_code" placeholder="Mã thiết kế"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                @include('admin.common.__select_design_type',['selectName' => 'design_type_id','defaultValue' => $product->design_type_id])
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label" for="text-input">Mô tả ngắn thiết kế</label>
                                            <div class="col-md-10">
                                                <textarea class="form-control" name="product_description" rows="9" placeholder="Nhập mô tả ngắn thông tin thiết kế">{{$product->product_description}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label" for="text-input">Nội dung thiết kế</label>
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-12">
