...
@section('head.title','Tạo mới loại thiết kế')
@section('head.css')
...
@section('body.breadcrumb')
    {{ Breadcrumbs::render('admin.designType.create') }}
@endsection
@section('body.content')
    <div class="container-fluid design_type">
        <div id="ui-view">
            <div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Tạo Mới Loại Thiết Kế</strong>
                                    <div class="card-header-actions">
                                        <a class="btn btn-block btn-outline-secondary active" href="{{route('admin.design_type.index')}}">
                                            Quay Lại
                                        </a>
                                    </div>
                                </div>
                                <form class="form-horizontal" action="{{route('admin.design_type.create')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="text-input">Tên Loại Thiết Kế</label>
                                            <div class="col-md-9">
                                                <input class="form-control" id="text-input" type="text" name="design_type_name" placeholder="Tên Loại Thiết Kế" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
...
{{--                                        </div>--}}
                                    ...
                                    <div class="card-footer text-right">
                                        ...
                                        <a class="btn btn-sm btn-danger" href="{{route('admin.design_type.index')}}">
