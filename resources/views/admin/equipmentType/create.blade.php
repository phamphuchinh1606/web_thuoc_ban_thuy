...
@section('head.title','Tạo mới loại thiết bị')
@section('head.css')
...
@section('body.breadcrumb')
    {{ Breadcrumbs::render('admin.equipmentType.create') }}
@endsection
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Tạo Mới Loại Thiết Bị</strong>
                                    <div class="card-header-actions">
                                        <a class="btn btn-block btn-outline-secondary active" href="{{route('admin.equipment_type.index')}}">
                                            Quay Lại
                                        </a>
                                    </div>
                                </div>
                                <form class="form-horizontal" action="{{route('admin.equipment_type.create')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="text-input">Tên Loại Thiết Bị</label>
                                            <div class="col-md-9">
                                                <input class="form-control" id="text-input" type="text" name="equipment_type_name" placeholder="Tên Loại Thiết Bị" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
...
{{--                                        </div>--}}
                                    ...
                                    <div class="card-footer text-right">
                                        ...
                                        <a class="btn btn-sm btn-danger" href="{{route('admin.equipment_type.index')}}">
